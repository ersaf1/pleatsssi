...
const socialLinks = [
  {
    name: "Facebook",
    href: "https://www.facebook.com/charleskeith.id/",
    icon: (
  ...
  {
    name: "Instagram",
    href: "https://instagram.com/charleskeithofficial/",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    name: "YouTube",
    href: "https://www.youtube.com/user/CharlesKeithChannel",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    name: "Twitter/X",
    href: "https://twitter.com/charles_keith",
    icon: <X className="w-5 h-5" />,
  },
  {
    name: "Pinterest",
    href: "https://www.pinterest.com/charleskeithofficial",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    name: "TikTok",
    href: "https://www.tiktok.com/@charleskeithofficial",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
