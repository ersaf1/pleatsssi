...
export async function seed() {
  ...
  const banners = [
    ...
    {
      type: "lifestyle",
      title: "Gaya Resort Elegan",
      subtitle: "Koleksi rok lipit premium untuk liburan Anda",
      image_url_desktop: "/images/lifestyle-resort.jpg",
      image_url_mobile: "/images/lifestyle-resort.jpg",
      cta_label: "Lihat Rok",
      cta_url: "/id/skirts",
      sort_order: 1,
      is_active: true,
    },
    {
      ...
      subtitle: "Celana lipit modern yang nyaman dan stylish",
      image_url_desktop: "/images/lifestyle-garden.jpg",
      image_url_mobile: "/images/lifestyle-garden.jpg",
      cta_label: "Lihat Celana",
      cta_url: "/id/pants",
      sort_order: 2,
      is_active: true,
    }
